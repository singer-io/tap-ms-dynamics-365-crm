...
from tap_ms_dynamics_365_crm.sync import write_schema, sync, update_currently_syncing
...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.IncrementalStream.sync")
