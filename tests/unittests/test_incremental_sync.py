...
class TestSync(unittest.TestCase):
    @patch("tap_ms-dynamics-365-crm.streams.abstracts.metadata.to_map")
    ...
    @patch("tap_ms-dynamics-365-crm.streams.abstracts.get_bookmark", return_value=100)
    ...
    @patch("tap_ms-dynamics-365-crm.streams.abstracts.get_bookmark", return_value=300)
