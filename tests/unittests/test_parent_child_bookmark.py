...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.ParentBaseStream.is_selected", return_value=True)
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.ParentBaseStream.get_bookmark", return_value=100)
    ...
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.BaseStream.is_selected", return_value=False)
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.IncrementalStream.get_bookmark", return_value = 100)
    ...
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.BaseStream.is_selected", return_value=True)
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.IncrementalStream.get_bookmark", side_effect = [100, 50, 75])
    ...
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.BaseStream.is_selected", return_value=False)
    @patch("tap_ms_dynamics_365_crm.streams.abstracts.IncrementalStream.get_bookmark", side_effect = [75, 50])
