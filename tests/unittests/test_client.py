...
class TestClient(unittest.TestCase):
    ...
    @patch("tap_ms-dynamics-365-crm.client.session")
    ...
    @patch("tap_ms-dynamics-365-crm.client.Client._Client__make_request")
    ...
    @parameterized.expand([
        ["400 error", 400, MockResponse(400), MSDynamics365CrmBadRequestError, "A validation exception has occurred."],
        ["401 error", 401, MockResponse(401), MSDynamics365CrmUnauthorizedError, "The access token provided is expired, revoked, malformed or invalid for other reasons."],
        ["403 error", 403, MockResponse(403), MSDynamics365CrmForbiddenError, "You are missing the following required scopes: read"],
        ["404 error", 404, MockResponse(404), MSDynamics365CrmNotFoundError, "The resource you have specified cannot be found."],
        ["409 error", 409, MockResponse(409), MSDynamics365CrmConflictError, "The API request cannot be completed because the requested operation would conflict with an existing item."],
    ])
    ...
    @parameterized.expand([
        ["422 error", 422, MockResponse(422), MSDynamics365CrmUnprocessableEntityError, "The request content itself is not processable by the server."],
        ["429 error", 429, MockResponse(429), MSDynamics365CrmRateLimitError, "The API rate limit for your organisation/application pairing has been exceeded."],
        ["500 error", 500, MockResponse(500), MSDynamics365CrmInternalServerError, "The server encountered an unexpected condition which prevented it from fulfilling the request."],
        ["501 error", 501, MockResponse(501), MSDynamics365CrmNotImplementedError, "The server does not support the functionality required to fulfill the request."],
        ["502 error", 502, MockResponse(502), MSDynamics365CrmBadGatewayError, "Server received an invalid response."],
        ["503 error", 503, MockResponse(503), MSDynamics365CrmServiceUnavailableError, "API service is currently unavailable."],
    ])
    @patch("time.sleep")
